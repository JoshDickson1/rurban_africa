...
export default function FAQSect() {
  ...
  return (
    <section className="relative bg-[#F9FBFA] dark:bg-[#064e3b] transition-colors duration-700 overflow-hidden py-10">
      ...
      <div className="mx-auto px-6 mt-10 max-w-7xl lg:px-14">
                ...
                >
                  ...
                  <AnimatePresence initial={false}>
                    {isActive && (
                      ...
                      >
                        <p className="px-6 pb-6 pt-2 text-emerald-100/70 leading-relaxed text-[15px] border-t border-white/8 dark:border-emerald-800">
                          {faq.answer}
                        </p>
                      </motion.div>
                    )}
