...
const audiences = [
  { id: 1, title: "Children/Youth", icon: Baby, desc: "Rural school children and young adults, targeted for education and career development to foster growth and local leadership.", img: "/foot1.jpeg" },
