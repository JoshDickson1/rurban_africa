...
/* ══════════════════════════════════════════════════
   PAGE
══════════════════════════════════════════════════ */
export default function Q12026() {
  return (
    <div
        ...
        <div className="grid lg:grid-cols-[1fr_300px] gap-14 items-start">
          ...
          <article className="min-w-0 space-y-0">
            ...
            <FadeIn>
              ...
              <Prose>
                Founded in 2025 as a Pan-African non-profit organization, Rurban
                Africa is dedicated to erasing the invisible lines that separate
                rural and peri-urban communities from urban opportunities. Our
                mission is rooted in the belief that every child, regardless of
                geographic location, deserves equal access to inspiration,
                education, and the tools to dream boldly and rise with Africa.
              </Prose>
              <Prose>
                Through community-led programs focused on education,
                youth/community empowerment, and pride in African identity, we
                deliver targeted interventions that foster self-belief, purpose,
                and collective progress. In the first quarter of 2026, we
                continued to advance this vision with measurable, on-the-ground
                impact in Nigeria's rural and peri-urban landscapes.
              </Prose>
            </FadeIn>
            ...
            <FadeIn>
              ...
              <Prose>
                Our flagship initiative, the Communities &amp; School Outreach,
                combines school visits, interactive motivational sessions, group
                recitations of the Rurban Africa Pledge, and the distribution of
                empowerment tools. These sessions emphasize:
              </Prose>
              <ul className="space-y-3 mb-6 pl-1">
                <BulletItem>
                  Building self-confidence and the courage to pursue ambitious
                  dreams
                </BulletItem>
                <BulletItem>
                  Developing leadership qualities and a vision for a greater
                  Africa
                </BulletItem>
                <BulletItem>
                  Promoting personal development, including hygiene practices
                  and career exploration
                </BulletItem>
                <BulletItem>
                  Reinforcing African pride and unity through the daily
                  affirmation of the Rurban Africa Pledge
                </BulletItem>
              </ul>
            </FadeIn>
            ...
            <FadeIn>
              ...
              <SectionHeading>
                The Rurban Africa Pledge Notebooks
              </SectionHeading>
              <Prose>
                At the heart of our outreach efforts are the Rurban Africa
                Pledge Notebooks, a signature, purpose-designed empowerment tool
                that transforms a simple school supply into a lasting source of
                motivation and self-affirmation.
              </Prose>
              <Prose>
                These notebooks are intentionally crafted to go beyond blank
                pages for notes or homework. Each one serves as a portable,
                daily companion that embeds empowering content to help children
                internalize positive self-talk, discipline, and a sense of
                shared African destiny.
              </Prose>
              ...
              <Prose>
                The notebooks extend our reach far beyond the immediate session.
                With over 3,000 distributed (exceeding the 1,950+ children
                directly reached), extras reach siblings, family members, and
                peers, creating ripple effects of inspiration within households
                and communities.
              </Prose>
              ...
              <Prose>
                Every child deserves a notebook that speaks to their greatness.
                Through the Pledge Notebooks, we are not merely distributing
                stationery, we are equipping young minds with daily reminders of
                their potential and their place in a rising Africa.
              </Prose>
            </FadeIn>
            ...
            <FadeIn>
              ...
              <Prose>
                Our team conducted multiple school engagements across Delta
                State and Enugu State, delivering inspirational programming
                directly to primary and secondary students:
              </Prose>
              ...
              <p className="mt-6 text-zinc-500 dark:text-emerald-100/40 text-[13px] italic">
                These activities spanned six communities and involved direct
                interaction with children in resource-constrained settings.
              </p>
            </FadeIn>
            ...
            <FadeIn>
                ...
                {METRICS.map((m) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-[12px] text-zinc-500 dark:text-emerald-100/50 leading-snug">
                        {m.label}
                      </p>
                    </div>
                  );
              ...
              <Prose>
                These outputs reflect efficient delivery. An average of
                approximately 325 children per community, with notebooks
                distributed at a ratio exceeding 1.5 per child reached, enabling
                broader family and peer influence.
              </Prose>
              <Prose>
                Qualitative indicators include high levels of participation
                (over 90% enthusiastic involvement in Pledge recitations),
                reports of increased confidence and aspiration among children,
                and positive feedback from educators noting greater engagement
                and pride in African identity.
              </Prose>
            </FadeIn>
            ...
            <FadeIn>
              ...
              <Prose>
                The true measure of our work lies in the moments of connection.
                Children reciting the Pledge with conviction; bright eyes
                lighting up as they articulate dreams of becoming doctors,
                engineers, or changemakers; teachers observing renewed
                motivation in the classroom. The Pledge Notebooks amplify these
                moments, providing a tangible reminder that sustains inspiration
                long after our visits conclude.
              </Prose>
            </FadeIn>
            ...
            <FadeIn>
              ...
              <Prose>
                Operating as an emerging organization, we navigate resource
                constraints while prioritizing authentic, community-embedded
                delivery. Follow-up mechanisms and longitudinal outcome tracking
                remain key priorities for refinement in subsequent quarters.
              </Prose>
              <Prose>
                Early lessons highlight the power of low-cost, high-engagement
                models such as the Pledge Notebooks in rural contexts, where
                presence, affirmation, and simple tools yield disproportionate
                returns.
              </Prose>
            </FadeIn>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-emerald-100/65 text-[14px] leading-relaxed mb-2">
                    The progress achieved in Q1 2026 demonstrates the potential
                    of focused, heartfelt action to bridge divides and unlock
                    potential. We invite individuals, corporations, foundations,
                    and fellow organizations to join us through donations
                    (including support for Pledge Notebook production and
                    distribution), volunteer participation, collaborative
                    programming, or amplification of our story.
                  </p>
                  <p className="text-emerald-100/65 text-[14px] leading-relaxed mb-8">
                    Together, we can ensure that no rural or peri-urban child is
                    denied the opportunity to dream and rise.
                  </p>
          ...
          <aside className="hidden lg:flex flex-col gap-6 sticky top-24">
                ...
                {METRICS.map((m) => {
                  ...
                  return (
                    <div key={m.label} className="flex items-center gap-3">
                      ...
                      <div>
                        <div
                          className="text-[15px] font-black text-zinc-900 dark:text-white leading-none mb-0.5"
                          style={{
                            fontFamily: "'Playfair Display', Georgia, serif",
                          }}
                        >
                        ...
                        <div className="text-[11px] text-zinc-400 dark:text-emerald-100/40 leading-snug">
                          {m.label}
                        </div>
                      </div>
                    </div>
            ...
            <div className="bg-white dark:bg-[#064e3b]/30 border border-zinc-100 dark:border-[#064e3b] rounded-2xl p-5">
              ...
              <p className="text-[12px] text-zinc-500 dark:text-emerald-100/50 leading-relaxed mb-4">
                Download the complete Q1 2026 Impact Update as a PDF for sharing
                or offline reading.
              </p>
              <a
                href="/Rurban_Africa_pdf_Q1!.pdf"
