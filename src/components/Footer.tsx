...
const Footer = () => {
  return (
    <footer className="relative z-40 bg-[url('/footer.png')] dark:bg-[url('/bg-footer.svg')] dark:bg-green-950 pt-20 pb-10 overflow-hidden transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-6">
                ...
                <ul className="space-y-4">
                  {links.map((link) => (
                    <li key={link.name}>
                      <Link
                        to={link.to}
                        className="group flex items-center text-slate-500 dark:text-slate-400 hover:text-[#1e3a5f] dark:hover:text-green-400 transition-colors font-semibold text-sm"
                      >
        ...
        <div className="py-5 flex items-start gap-3">
          <div className="w-8 h-8 rounded-lg bg-green-100 dark:bg-green-900/40 border border-green-200 dark:border-green-800/40 flex items-center justify-center shrink-0 mt-0.5">
            <Building2 size={14} className="text-green-600 dark:text-green-400" />
          </div>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">
            ...
            <a href="tel:+2349130993464" className="text-[#1e3a5f] dark:text-green-400">BiTech</a>
          </p>
